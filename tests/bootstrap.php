...
$_meetings_plugin_file = getenv( 'WP_PLUGIN_FILE' ) ? getenv( 'WP_PLUGIN_FILE' ) : $_core_dir . '/wp-content/plugins/disciple-tools-meetings/disciple-tools-meetings.php';
 ...
 * Registers theme
 */
$_register_theme = function () use ( $_tests_dir, $_core_dir, $_theme_dir, $_plugin_file, $_meetings_plugin_file ) {
