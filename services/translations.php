...
class Disciple_Tools_Three_Thirds_Meetings_Translations {
    ...
    public function all() {
        return [
            ...
            'edit_meeting'          => __( 'Edit Meeting', Disciple_Tools_Three_Thirds::DOMAIN ),
            ...
            'prayer_requests_label' => __( 'Prayer requests go here.', Disciple_Tools_Three_Thirds::DOMAIN ),
            'previous'              => __( 'Previous', Disciple_Tools_Three_Thirds::DOMAIN ),
            'previous_meeting'      => __( 'Previous Meeting', Disciple_Tools_Three_Thirds::DOMAIN ),
            ...
            'name'                  => __( 'Name', Disciple_Tools_Three_Thirds::DOMAIN ),
            ...
            "notes_label"           => __( 'Notes go here', Disciple_Tools_Three_Thirds::DOMAIN ),
            'number_present_label'  => __( 'How many members are present?', Disciple_Tools_Three_Thirds::DOMAIN ),
            'number_shared_label'   => __( 'How many did you share with?', Disciple_Tools_Three_Thirds::DOMAIN ),
            'practice'              => __( 'Practice', Disciple_Tools_Three_Thirds::DOMAIN ),
            'share_goal_label'      => __( 'How many people are we going to share with?', Disciple_Tools_Three_Thirds::DOMAIN ),
